...
output_folder_path = "C:\\Users\\DA\\Desktop\\wrds\\new-data\\6.15\\roberta"

# Read data
data = pd.read_csv(input_file_path)

# Initialize sentiment analysis model with RoBERTa
...
plt.title('Model accuracy through time for each ticker: roberta')
plt.legend(title='Ticker', bbox_to_anchor=(1.05, 1), loc='upper left')
plt.grid(True)

# Save plot
output_path = f'{output_folder_path}\\Model_accuracy_through_time_for_each_ticker_roberta.png'
