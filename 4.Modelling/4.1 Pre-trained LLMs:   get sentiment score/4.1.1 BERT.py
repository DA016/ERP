...
# Initialize sentiment analysis model with BERT
bert_model_name = "bert-base-uncased"
pipe = pipeline("sentiment-analysis", model=bert_model_name)
...
data['score'] = get_sentiment_scores(data['wheadline'].tolist(), model, tokenizer)
print(f"Sentiment calculation time: {time.time() - start_time} seconds")

# Save file with scores
score_output_file = f"{output_folder_path}\\Ticker-Week-wheadline-ndirection-nret-score.csv"
...
# Read CSV file
file_path = r'C:\Users\DA\Desktop\wrds\new-data\6.15\bert\Ticker-Accuracy-Year.csv'
...
plt.title('Model accuracy through time for each ticker: bert')
plt.legend(title='Ticker', bbox_to_anchor=(1.05, 1), loc='upper left')
plt.grid(True)

# Save plot
output_path = r'C:\Users\DA\Desktop\wrds\new-data\6.15\bert\Model_accuracy_through_time_for_each_ticker_bert.png'
...
output_path = r'C:\Users\DA\Desktop\wrds\new-data\6.15\bert\Ticker_Accuracy_Summary_Stats.csv'
